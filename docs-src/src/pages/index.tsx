...
const features = [
  {
    ...
    href: '/Eidolon/docs/build/features/chat',
  },
  {
    icon: '🎙️',
    title: '语音 & 视频通话',
    desc: '像打电话一样和 AI 对话，面对面视频陪伴',
    href: '/Eidolon/docs/build/features/video-call',
  },
  {
    icon: '✅',
    title: '待办 & 习惯',
    desc: 'AI 帮你管理任务、养成好习惯、记录心情',
    href: '/Eidolon/docs/build/features/todo',
  },
  {
    icon: '🎭',
    title: '小剧场',
    desc: '沉浸式互动剧情，与 AI 共创独特故事',
    href: '/Eidolon/docs/build/features/theater',
  },
  {
    icon: '🎨',
    title: 'AI 画图',
    desc: '用文字描述就能生成精美图片',
    href: '/Eidolon/docs/build/features/image-generation',
  },
  {
    icon: '🧠',
    title: '长期记忆',
    desc: 'AI 记住你的每一个重要时刻，越聊越懂你',
    href: '/Eidolon/docs/build/features/memory',
  },
  {
    icon: '⏰',
    title: '专注 & 提醒',
    desc: '番茄钟专注模式 + 闹钟提醒，AI 陪你一起',
    href: '/Eidolon/docs/build/features/focus-timer',
  },
  {
    icon: '🤖',
    title: 'AI 代理',
    desc: '让 AI 帮你操作电脑、搜索信息、执行任务',
    href: '/Eidolon/docs/build/features/agent',
  },
  {
    icon: '🎨',
    title: '主题 & 个性化',
    desc: '9 套精美主题、角色模型、声音定制',
    href: '/Eidolon/docs/build/features/theme',
  },
];
      ...
      <main className="eid-home">
        ...
        <section className="eid-hero">
          ...
          <div className="eid-hero__content">
            ...
            <div className="eid-hero__actions">
              <a className="eid-btn eid-btn--primary" href="/Eidolon/docs/build/quick-start">
                <span>快速上手</span>
              ...
              <a className="eid-btn eid-btn--ghost" href="/Eidolon/docs/build/features/chat">
                功能详解
              </a>
              <a className="eid-btn eid-btn--ghost" href="/Eidolon/docs/build/faq">
                常见问题
              </a>
            </div>
          </div>
        ...
        <section className="eid-cta">
          <div className="eid-cta__container">
            ...
            <a className="eid-btn eid-btn--primary eid-btn--lg" href="/Eidolon/docs/build/quick-start">
              <span>开始使用</span>
